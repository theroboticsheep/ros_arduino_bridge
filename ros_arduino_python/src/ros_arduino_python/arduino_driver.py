...
if __name__ == '__main__':
    ...
    rospy.loginfo('Reading on analog port 0', myArduino.analog_read(0))
    rospy.loginfo('Reading on digital port 0', myArduino.digital_read(0))
    rospy.loginfo('Blinking the LED 3 times')
    for i in range(3):
        myArduino.digital_write(13, 1)
        time.sleep(1.0)
    #rospy.loginfo('Current encoder counts', myArduino.encoders())
    ...
    rospy.loginfo('Shutting down Arduino.')
